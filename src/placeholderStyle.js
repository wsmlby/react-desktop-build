...
var _default = function (_Component) {
  ...
  function _default() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(_default).call(this));
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      var placeholderStyle = _props.placeholderStyle;

      var props = _objectWithoutProperties(_props, ['children', 'placeholderStyle']);

      return _react2.default.createElement('div', _extends({ 'data-reactdesktopid': this._id }, props), children, _react2.default.createElement(_radium.Style, { rules: mapRules('[data-reactdesktopid="' + this._id + '"]', placeholderStyle) }));
    }
  }]);
