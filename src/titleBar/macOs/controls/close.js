...
var Close = (_dec = (0, _windowFocus2.default)(), _dec(_class = (0, _radium2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Close, [{
    ...
    value: function render() {
      ...
      }, props), _react2.default.createElement('svg', { x: '0px', y: '0px', width: '6px', height: '6px', viewBox: '0 0 6 6', style: iconStyle }, _react2.default.createElement('polygon', { fill: '#4d0000', points: '6,0.8 5.2,0 3,2.2 0.8,0 0,0.8 2.2,3 0,5.2 0.8,6 3,3.8 5.2,6 6,5.2 3.8,3 ' })));
    }
  }]);
