...
var Controls = (_temp = _class = function (_Component) {
  ...
  _createClass(Controls, [{
    ...
    value: function render() {
      ...
      }, _react2.default.createElement(_close2.default, { onClick: this.props.onCloseClick, showIcon: this.state.isOver }), _react2.default.createElement(_minimize2.default, { onClick: this.props.onMinimizeClick, showIcon: this.state.isOver }), _react2.default.createElement(_resize2.default, {
        isFullscreen: this.props.isFullscreen,
        onClick: this.props.onResizeClick,
        onMaximizeClick: this.props.onMaximizeClick,
        showIcon: this.state.isOver
      }), _react2.default.createElement(_lock2.default, { onLockClick: this.props.onLockClick, onUnlockClick: this.props.onUnlockClick, showIcon: this.state.isOver }));
    }
  }]);
