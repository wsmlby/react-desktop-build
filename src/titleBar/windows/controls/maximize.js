...
var Maximize = (_dec = (0, _windowFocus2.default)(), _dec(_class = (0, _radium2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  function Maximize() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Maximize).apply(this, arguments));
  }
  ...
  _createClass(Maximize, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['style', 'isWindowFocused']);
      ...
      var title = 'Maximize';
      var icon = _react2.default.createElement('svg', { x: '0px', y: '0px', viewBox: '0 0 10.2 10.1', style: styles.icon }, _react2.default.createElement('path', {
        fill: svgFill,
      ...
      if (this.context.isMaximized) {
        title = 'Restore Down';
        icon = _react2.default.createElement('svg', { x: '0px', y: '0px', viewBox: '0 0 10.2 10.2', style: styles.icon }, _react2.default.createElement('path', {
          fill: svgFill,
